defmodule DailyTwang.Accounts.Account do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, DailyTwang.Repo)
  ...
  """
  def valid_password?(%DailyTwang.Accounts.Account{hashed_password: hashed_password}, password)
