defmodule DailyTwangWeb.AccountAuthTest do
  use DailyTwangWeb.ConnCase, async: true

  alias DailyTwang.Accounts
  alias DailyTwangWeb.AccountAuth
  import DailyTwang.AccountsFixtures

  @remember_me_cookie "_daily_twang_web_account_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DailyTwangWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      DailyTwangWeb.Endpoint.subscribe(live_socket_id)
